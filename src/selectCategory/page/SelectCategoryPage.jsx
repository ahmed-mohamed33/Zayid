...
export default function SelectCategoryPage() {
  ...
  const categories = [
    { id: 'cars', name: 'سيارات', icon: '/assets/categry/car.svg' },
    {
      id: 'jewels',
      name: 'مجوهرات و معادن نادرة',
      icon: '/assets/categry/الماس.svg',
    },
    {
      id: 'art',
      name: 'تحف و أعمال فنية',
      icon: '/assets/categry/ArtGallery.svg',
    },
    {
      id: 'realestate',
      name: 'عقارات و أراضي',
      icon: '/assets/categry/مبنى.svg',
    },
    {
      id: 'scrap',
      name: 'الخردة و بواقي المعادن',
      icon: '/assets/categry/Clippathgroup.svg',
    },
    { id: 'furniture', name: 'أثاث', icon: '/assets/categry/اثاث.svg' },
    { id: 'electronics', name: 'إلكترونيات', icon: '/assets/categry/لاب.svg' },
  ];
