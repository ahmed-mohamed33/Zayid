...
const faqData = [
  ...
  },
  {
    ...
    answer: (
      <ul className="list-disc pr-6 space-y-1">
        ...
        <li>
          معاينة لايف فيديو: مكالمة فيديو مباشرة مع البائع لمشاهدة المنتج.
        </li>
        <li>
          معاينة إلكترونية: من خلال الصور والفيديوهات التي يرفعها البائع على
          المنصة.
        </li>
      </ul>
    ),
  ...
  },
  {
    ...
    answer: (
      <div>
        <div>
          إذا كنت بائعًا أو تود عرض منتجاتك للبيع بالمزاد، اتبع الخطوات التالية:
        </div>
        <ul className="list-disc pr-6 space-y-1 mt-2">
          <li>أنشئ حساب بائع على المنصة (تسجيل الدخول / تسجيل كيان).</li>
          <li>
            قم بإضافة مزاد جديد من صفحة "إضافة مزاد جديد"، واملأ البيانات:
          </li>
          ...
          <li>
            أرفق كراسة الشروط أو البيانات داخل المزاد (تحتوي على تفاصيل المنتج،
            شروط التسليم، وطريقة المعاينة).
          </li>
          <li>حدد نوع المعاينة (حضور شخصي - لايف فيديو - إلكترونية).</li>
          <li>
            انتظر موافقة فريق ZAYID وسيتم إبلاغك عند تفعيل المزاد وبدء عرض
            المنتج للمستخدمين.
          </li>
        </ul>
        <div className="font-bold mt-4">
          بعد انتهاء المزاد وفوز أحد المشترين، يتم إعلامك لإتمام الخطوات التالية
          (تسليم، استلام المبلغ... إلخ).
        </div>
      </div>
    ),
  },
          ...
          {faqData.map((item, idx) => (
            ...
            >
              <button
                ...
                className={`w-full flex items-center justify-between text-right px-6 py-5 md:py-6 text-lg md:text-xl font-bold text-gray-800 focus:outline-none transition-colors duration-150 ${
                  openIndex === idx
                    ? "border-b border-gray-100 rounded-t-xl bg-gray-50"
                    : "hover:bg-gray-50"
                }`}
              >
                <span>{item.question}</span>
                <span
                  className={`text-orange-500 text-2xl transition-transform duration-200 ${
