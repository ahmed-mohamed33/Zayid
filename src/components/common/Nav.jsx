...
function Nav() {
  return (
    <>
    <div className='Navbar  flex items-center py-3 px-7 bg-[#ffffff] justify-between shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] z-10"'>
        ...
        <ul className=' flex items-center'>
            ...
            <li><Link className={ulStyle}>المزادات</Link></li>
