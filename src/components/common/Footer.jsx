      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className={linkListClass}>
            <li><a href="#" className={linkItemClass}>من نحن</a></li>
            <li><a href="#" className={linkItemClass}>الأسئلة الشائعة</a></li>
            <li><a href="#" className={linkItemClass}>سياسة الخصوصية</a></li>
            <li><a href="#" className={linkItemClass}>اتصل بنا</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className={linkListClass}>
            <li><a href="#" className={linkItemClass}>إلكترونيات</a></li>
            <li><a href="#" className={linkItemClass}>عقارات</a></li>
            <li><a href="#" className={linkItemClass}>سيارات</a></li>
            <li><a href="#" className={linkItemClass}>تحف وأنتيكات</a></li>
            <li><a href="#" className={linkItemClass}>مجوهرات</a></li>
          </ul>
        </div>
            ...
            <div dir="rtl" className="join">
              <div>
                <label className="input join-item">
                  <input className="text-black" type="text" placeholder="  البريد ألالكتروني" />
                </label>
              </div>
