    ...
    <div className="bg-[#F1F1F1] min-h-screen pt-10 pb-24 px-4 sm:px-10">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <form className="space-y-4">
            <InputField
              ...
              icon="/assets/contact/profile.svg"
            />
            <InputField
              label="البريد الإلكتروني"
              placeholder="ادخل بريدك الإلكتروني"
              icon="/assets/contact/sms-black.svg"
            />
            <InputField
              label="رسالتك"
              placeholder="اكتب رسالتك"
              icon="/assets/contact/message-text.svg"
              textarea
            />
            <button
              type="submit"
        ...
        <div className="space-y-6">
          <ContactCard
            icon="/assets/contact/sms.svg"
            title="البريد الإلكتروني"
            value="support@zayed.com"
          />
          <ContactCard
            icon="/assets/contact/call.svg"
            title="رقم الهاتف"
            value="0100 123 4567"
          />
          <ContactCard
